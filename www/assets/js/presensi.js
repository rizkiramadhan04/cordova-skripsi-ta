        ...
        result_list += '<a href="javascript:void(0)">'+
           '<div class="row detail item mb-2 p-0">'+
              '<div style="line-height:1.2rem;" class="col-6 pt-1 pb-1">'+
                  '<strong>'+(data_ls.tanggal_masuk != null ? 'Presensi' : 'Izin')+'</strong>'+
                  '<p>Nama  : <strong>'+data_ls.nama+'</strong><br/></p>'+
                  '<p>Waktu : <strong>'+data_ls.waktu_masuk+'</strong><br/></p>'+
                  '<p>Tanggal : <strong>'+(data_ls.tanggal_masuk != null ? data_ls.tanggal_masuk : data_ls.tanggal_izin)+'</strong><br/></p>'+
                  '<p>Izin : <strong>'+(data_ls.izin != null ? data_ls.alasan_izin : '-')+'</strong><br/></p>'+
                  '</div>'+
              '<div class="col-3 text-center">'+
                  '<p><b> Status <b/><br/></p>'+
                  '<p><strong style="font-size:.8rem;">'+(data_ls.status_masuk != null ? data_ls.status_masuk : '-')+'</strong></p>'+
              '</div>'+
           '</div>'+
       '</a>';
      }
